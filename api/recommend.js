...
- 5개를 채우기 위해 불확실한 작품을 넣지 마세요. 확실한 작품만 추천하세요.
 
[제목 규칙]
- 웹 검색으로 TMDB(themoviedb.org) 또는 해당 OTT 플랫폼에서 실제 존재 여부를 확인 후 추천하세요.
- 웹소설 원작의 경우 웹소설을 제목으로 추천하지 마세요
...
[
  {
    ...
    "reason": "웹 검색으로 확인한 실제 내용을 바탕으로, 왜 지금 이 사용자 상황에 딱인지 2~3문장(구체적으로). URL 포함 금지."
  }
]`;
  try {
