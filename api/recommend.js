...
- "~같은 분위기", "~처럼", "~같은 거" → 해당 작품의 분위기·장르·테마와 유사한 작품을 후보 목록의 description을 참고해서 선별하세요
- 이미 본 작품 언급 → 해당 작품과 비슷하지만 다른 작품 추천
- 감정/기분 표현 → 그 감정에 맞는 작품 추천
- 현재 상황 설명 → 상황에 어울리는 작품 추천
- 피하고 싶은 것 언급 → 해당 요소 배제
- 특정 배우/감독 언급 → 관련 작품 우선
추가 요청은 장르·분위기 칩 선택과 동등하게 반영하세요. 후보 목록의 description을 적극 활용해서 분위기가 가장 유사한 작품을 선별하세요.
