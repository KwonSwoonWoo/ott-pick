...
[
  {
    ...
    "hook": [hook 작성 절대 규칙 - 20자 내외]
    1. 추상적 형용사 금지: "감동적인", "흥미진진한", "강력한 액션", "반전 매력" 등은 절대 쓰지 마세요.
    2. 사건/설정 중심: 작품의 가장 자극적이거나 독특한 '설정'이나 '첫 장면'을 한 문장으로 요약하세요.
    3. 타겟팅: 사용자의 상황(누구랑, MBTI, 기분)과 작품의 핵심 사건을 연결하세요.

- 좋은 예시:
  * "헤어진 전남친이 내 옆집으로 이사 왔다"
  * "AI가 지배하는 세상, 인간은 배터리로 쓰인다"
  * "범인을 잡으려다 내가 살인 용의자가 됐다"
  * "술 한 잔에 과거로 돌아가는 마법 같은 밤"
